...
<head>
    ...
    <title>UPDATE TRANSPORT NUMBER</title>
</head>
...
<body>
    ...
    <div class="container">
        <form method="post" action="updatetrans.php">
            ...
            <div class="box" offset-sm-4>
                ...
                <div class="content">
                    <h2 align="center">UPDATE TRANSPORT NUMBER</h2><br>
                    ...
                    <div class="form-group">
                        <label for="trans">Bus Number</label>
                        <input type="number" class="form-control" name="Transport" id="trans" placeholder="Enter your Bus number" maxlength="3" required>
                    </div><br>
	...
	if(isset($_POST['submit']))
	{
		...
		if($regno!="" && $trans!="")
		{ 
		   $sql = "UPDATE studentdetails SET Transport='$trans' WHERE registerNo='$regno'";
		   if($link->query($sql))
		  { 
