...
<body>
    ...
    <div class="container">
        <form method="post" action="updateemail.php">
            <div class="box offset-sm-4">
                ...
                <div class="content">
                    <h2 ALIGN="center">UPDATE EMAIL ADDRESS</h2><br>
                    <div class="form-group">
                        <label for="regno">Register Number</label>
                        <input type="number" class="form-control" id="registerNo" name="registerNo" placeholder="Enter your register number" maxlength="7" required>
                        <small id="emailHelp" class="form-text text-muted">Enter your correct register number for update.</small>
                    </div>
                    <div class="form-group">
                        <label for="email">Email Address</label>
                        <input type="email" class="form-control" id="email" name="email" pattern=".+@gmail.com" placeholder="123@gmail.com" required>
                    </div><br>
	...
	if(isset($_POST['submit']))
	{
		...
		if($regno!="" && $email!="")
		{ 
		   $sql = "UPDATE studentdetails SET email='$email' WHERE registerNo='$regno'";
		   if($link->query($sql))
		  { 
